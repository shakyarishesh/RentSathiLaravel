    ...
    <div align="center" class="container">
        ...
        <form action="/upload/add" enctype="multipart/form-data" method="post">
          ...
          <option value="2BHK">2BHK</option> -->
            <label for="Location" class="section">Location:</label><br /> <select class="rentType" id="location"
            ...
            <label for="title" class="section">Title:</label> <input type="text" id="title"
                name="title"> <label for="price" class="section">Price:
            </label> <input type="number" id="price" name="price"> <label for="description"
                class="section">Description: </label>
