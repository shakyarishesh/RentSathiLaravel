...
<body>
    ...
    <div class="container" id="registration-form">
        ...
        <form action="/registerPost" method="get">
            @csrf
            <div class="form">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="phone" id="phonenum" placeholder="Enter mobile number"
                                required>
                        </div>
                        <div class="input-field">
                            <label>Gender</label>
                ...
                <div class="details ID">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="issuedAuthority" placeholder="Enter issued authority" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="details address">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <select id="province" class="select2" name="province" required>
                ...
                <div class="details">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            <input type="password" name="password" placeholder="Enter your password" id="pd1"
                                required>
